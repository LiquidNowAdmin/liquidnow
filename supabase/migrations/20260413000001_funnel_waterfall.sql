-- ============================================
-- Migration: Funnel Waterfall Aggregation
-- Returns unique session counts per funnel stage
-- for the admin waterfall chart
-- ============================================
...
grant execute on function admin_get_funnel_waterfall to authenticated;
