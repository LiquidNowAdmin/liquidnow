...
function AnbieterEditForm() {
  ...
  if (!id) {
    return <p className="text-subtle">Keine Anbieter-ID angegeben.</p>;
  }
  ...
  return (
    <>
      <div className="admin-page-header">
        <h1 className="admin-page-title">Anbieter bearbeiten</h1>
      </div>
...
export default function AnbieterEditPage() {
  return (
    <Suspense
      fallback={
        <div className="admin-page-header">
