...
export const VARIABLES: VariableDef[] = [
  ...
  { key: "application.volume", label: "Beantragter Betrag", description: "Gewünschter Kreditbetrag", example: "50.000 €", source: "company" },
  { key: "application.term_months", label: "Laufzeit (Monate)", description: "Gewünschte Laufzeit", example: "24", source: "company" },
...
<tr><td style="padding:32px 32px 8px 32px;"><a href="${COMPANY.url}" style="text-decoration:none;display:inline-block;"><span style="font-family:'Poppins','Inter',Helvetica,Arial,sans-serif;font-size:24px;font-weight:700;letter-spacing:-0.02em;line-height:1;"><span style="color:#D4872C;">L</span><span style="color:#D4872C;">i</span><span style="color:#D4872C;">Q</span><span style="color:#D4872C;">i</span><span style="color:#507AA6;">Now</span></span><div style="margin-top:2px;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:10px;font-weight:500;color:#5b6478;letter-spacing:0.02em;">Deutsche Einkaufsfinanzierer</div></a></td></tr>
